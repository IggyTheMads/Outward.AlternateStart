namespace AlternateStart
{
    public enum ScenarioPassives
    {
        ...
        LevantSlums = -2207, // +weathers, needs n speed. Lower hp n stam LOC
        EnmerkarHunter = -2208, // bonus bandages, potion puke LOC
        PriestElatt = -2209, // mana bonus dmg, lower physical LOC
